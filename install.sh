...
[ -e $HOME/gandalf/src/github/bayprogrammer/dotfiles/private/ssh/authorized_keys ] && \
    ln -s $HOME/gandalf/src/github/bayprogrammer/dotfiles/private/ssh/authorized_keys \
        $HOME/.ssh/authorized_keys
[ -e $HOME/.ssh/id_rsa -o -L $HOME/.ssh/id_rsa ] && rm $HOME/.ssh/id_rsa
[ -e $HOME/gandalf/src/github/bayprogrammer/dotfiles/private/ssh/id_rsa  ] && \
    ln -s $HOME/gandalf/src/github/bayprogrammer/dotfiles/private/ssh/id_rsa \
        $HOME/.ssh/id_rsa
[ -e $HOME/.ssh/id_rsa.pub -o -L $HOME/.ssh/id_rsa.pub ] && rm $HOME/.ssh/id_rsa.pub
[ -e $HOME/gandalf/src/github/bayprogrammer/dotfiles/private/ssh/id_rsa.pub ] && \
    ln -s $HOME/gandalf/src/github/bayprogrammer/dotfiles/private/ssh/id_rsa.pub \
        $HOME/.ssh/id_rsa.pub
